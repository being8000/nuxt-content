      ...
      <div class="
        ...
        <div class="relative flex items-center">
          ...
          <div class="relative hidden lg:flex items-center ml-auto">
            <nav class="
              ...
              <ul class="flex space-x-8">
                <li>
                  <a class="hover:text-sky-500 dark:hover:text-sky-400" href="/docs/installation">Home</a>
                </li>
                <li>
          ...
          <!-- <button type="button" class="
            ...
            ">
            <span class="sr-only">Search</span><svg width="24" height="24" fill="none" stroke="currentColor"
              stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
              <path d="m19 19-3.5-3.5"></path>
              <circle cx="11" cy="11" r="6"></circle>
            </svg>
          </button> -->
          <div class="ml-2 -my-1 lg:hidden ml-auto">
            <button type="button" class="
                text-slate-200
                w-8
                h-8
